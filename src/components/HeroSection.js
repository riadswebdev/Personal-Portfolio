...
export default function HeroSection() {
  ...
  return (
    <section
      ref={container}
      className="min-h-[819px] flex flex-col md:flex-row items-center justify-between py-section-gap gap-stack-lg relative"
      id="home"
    >
      ...
      <div className="hero-content flex-1 space-y-stack-md text-center md:text-left">
        ...
        <h1 className="section-title text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500 max-w-2xl pb-2">
          Crafting High-Performance Web Experiences
        </h1>
        <TypewriterBanner />
        <p className="font-body-lg text-body-lg text-on-surface-variant max-w-xl">
          Turning ideas into clean UI designs with smooth animations and
          performance optimization. 📍 Dhaka, Bangladesh.
        </p>

        <div className="flex flex-col sm:flex-row flex-wrap items-center gap-4 pt-stack-md justify-center md:justify-start">
          <a
            href="/cv.html"
            target="_blank"
            ...
            className="bg-primary-container text-on-primary-container px-6 py-3 rounded-lg font-bold text-xl hover:shadow-[0_0_20px_rgba(0,240,255,0.4)] transition-all text-center inline-block"
          >
            Download Resume
          </a>
          <a
            ...
            onMouseMove={handleMagneticMove}
            onMouseLeave={handleMagneticLeave}
            className="border-2 border-primary-container text-primary-container px-6 py-3 rounded-lg font-bold text-xl hover:bg-primary-container hover:text-on-primary-container hover:shadow-[0_0_20px_rgba(0,240,255,0.4)] transition-all text-center inline-block"
          >
            View Projects
          </a>
          <div className="flex gap-4  mt-2">
            <a
              className="w-12 h-12 flex items-center justify-center rounded-full glass-card hover:text-primary-container hover:scale-110 transition-all"
