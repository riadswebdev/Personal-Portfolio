  ...
  return (
    <div className="mt-section-gap relative w-full">
      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-none transform -translate-y-[99%]">
        <svg
          className="relative block w-[calc(100%+1.3px)] h-[60px] md:h-[100px] text-slate-950"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1200 120"
          preserveAspectRatio="none"
        >
          <path
            d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V95.8C59.71,118.08,130.83,121.3,201.3,114.63,242.42,110.74,282.88,96.53,321.39,56.44Z"
        ...
        <div className="max-w-[1280px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="flex flex-col gap-4">
              <Image
                src="https://i.ibb.co.com/MDkd2s9V/Designer-12.png"
                alt="Riad Shekh Logo"
                width={500}
                height={500}
              ...
              <p className="text-slate-500 text-sm leading-relaxed max-w-xs">
                ...
                clean UI design using React and Next.js.
              </p>
              {/* Social icons */}
            ...
            <div>
              ...
              <ul className="flex flex-col gap-4">
                <li>
                  ...
                  >
                    <span className="w-9 h-9 flex items-center justify-center rounded-lg border border-slate-700 group-hover:border-cyan-400 transition-colors text-base">
                      ✉
                    </span>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="text-sm">
                      github.com/djriad157764-creator
                    </span>
                  </a>
                </li>
                <li>
